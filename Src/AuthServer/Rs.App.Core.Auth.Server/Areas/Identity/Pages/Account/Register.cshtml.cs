        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    Status = EnumUserStatus.Submitted
                };
                ...
                if (result.Succeeded)
                {
                    ...
                    else if (user.Status != EnumUserStatus.Approved)
                    {
                        result.Errors.ToList().Add(new IdentityError()
                        {
                            Description = "Registed, now wait for your account to be approved. Contact vendor if requried",
                            Code = ""
                        });

                        ModelState.AddModelError(string.Empty, "Registed, now wait for your account to be approved. Contact vendor if requried");
                    }
                }
