...
{
    public class ProductNewAddedEvent : IDomainEvent<ProductAddDto>
    {
        private readonly IAuditRepository _auditRepository;

        public ProductNewAddedEvent(IAuditRepository auditRepository)
        {
            _auditRepository = auditRepository;
        }

        public void Raise(AbstractModel model)
        {
